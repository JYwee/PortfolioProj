...
enum class BossDragonAIControlState : uint8
{
	None UMETA(DisplayName = "사용안함"),
	Idle UMETA(DisplayName = "서있기"),
	IdleFlyStaionary UMETA(DisplayName = "공중에서 대기"),
	MoveWork UMETA(DisplayName = "걷기이동"),
	MoveRun UMETA(DisplayName = "달리기이동"),
	MoveFly UMETA(DisplayName = "공중에서이동"),
	AttackMelee UMETA(DisplayName = "공격"),
	AttackMeleeCombo UMETA(DisplayName = "연속공격"),
	Return UMETA(DisplayName = "복귀"),
	Patrol UMETA(DisplayName = "정찰"),
	Death UMETA(DisplayName = "죽음"),
	FireBall UMETA(DisplayName = "특수스킬1번"),
